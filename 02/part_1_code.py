...
def wrapping_paper_area_for_dimensions(dimensions):
...
total_wrapping_paper_area = sum([wrapping_paper_area_for_dimensions(dimensions) for dimensions in parsed_dimensions])
